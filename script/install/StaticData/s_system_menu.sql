...
INSERT INTO `s_system_menu`(MENU_ID,NAME,VALUE,TYPE,ICON,EXTENAL,FRESH,URL,PARENT_ID,FUNCTION_ID) VALUES (11000,'userManage','用户管理','','icon icon-home','','','userManage.action',10000,1);
INSERT INTO `s_system_menu`(MENU_ID,NAME,VALUE,TYPE,ICON,EXTENAL,FRESH,URL,PARENT_ID,FUNCTION_ID) VALUES (12000,'groupManage','用户组管理','','icon icon-home','','','groupManage.action',10000,1);
