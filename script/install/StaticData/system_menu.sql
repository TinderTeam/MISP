...
INSERT INTO `s_system_menu`(MENU_ID,NAME,VALUE,TYPE,ICON,EXTENAL,FRESH,URL,PARENT_ID,FUNCTION_ID) VALUES (11000,'groupManage','权限组管理','','icon icon-home','','','IndexInit.do',10000,1);
...
INSERT INTO `s_system_menu`(MENU_ID,NAME,VALUE,TYPE,ICON,EXTENAL,FRESH,URL,PARENT_ID,FUNCTION_ID) VALUES (13000,'orgManage','组织机构管理','','icon icon-home','','','orgMenage.do',10000,1);
